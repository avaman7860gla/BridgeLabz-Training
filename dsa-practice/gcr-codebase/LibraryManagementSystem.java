public class LibraryManagementSystem {
    ...
    public static void main(String[] args) {
        ...
        library.addAtBeginning("1984", "Orwell", "Dystopian", 1, true);
        library.addAtEnd("Pride and Prejudice", "Austen", "Romance", 2, true);
        library.addAtPosition(2, "The Hobbit", "Tolkien", "Fantasy", 3, false);
